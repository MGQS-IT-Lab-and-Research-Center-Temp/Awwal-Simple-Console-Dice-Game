...
System.Console.Write("====== Dice Game ======\ntype 'Start' or 'S' to roll the dice: ");
    string startRoll = Console.ReadLine()!;
    bool startController =  if (!(startRoll.Equals("Start", StringComparison.OrdinalIgnoreCase) || startRoll.Equals("S", StringComparison.OrdinalIgnoreCase)))
    {
        
    };
    while (startController){
        System.Console.WriteLine("Invalid Key provided");
        System.Console.Write("====== Dice Game ======\ntype 'Start' or 'S' to roll the dice: ");
        string startRoll = Console.ReadLine()!;
    }
